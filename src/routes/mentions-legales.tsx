      ...
      <main className="pt-28">
        <section className="relative overflow-hidden border-b border-border/60 py-20 sm:py-28">
          ...
          <div className="relative mx-auto max-w-5xl px-5 lg:px-10">
            <Parallax speed={-0.03}>
              <p className="label-mono text-[10px] uppercase tracking-[.25em] text-primary">
                XR AGENCY · LEGAL
              </p>
              <h1 className="display-serif mt-5 text-[clamp(3rem,8vw,7rem)] leading-[.86]">
                {t(UI.legalTitle)}
              </h1>
            ...
            <div className="mt-10 grid gap-3 sm:grid-cols-3">
              {[
                [Building2, t({ fr: "KARMA SASU", en: "KARMA SASU", vi: "KARMA SASU", ar: "KARMA SASU", ru: "KARMA SASU" })],
            ...
            <Reveal delay={120}>
              <div className="mt-5 rounded-3xl border border-border bg-card/60 p-7">
                <div className="flex items-center gap-3">
                  ...
                  <p className="label-mono text-[9px] uppercase tracking-[.2em] text-primary">{t(UI.legalPrivacy)}</p>
                </div>
                <p className="mt-5 max-w-4xl text-sm leading-7 text-muted-foreground">{t(UI.legalPrivacyText)}</p>
                <a href="mailto:contact.xragency@gmail.com" className="mt-5 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-4 py-2.5 text-xs text-primary hover:bg-primary/10">
