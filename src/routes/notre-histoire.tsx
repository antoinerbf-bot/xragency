...
function StoryPage() {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-background text-foreground"><Nav/><main className="pt-28">
    ...
    <section className="border-b border-border/60 py-20 sm:py-28 lg:py-36"><div className="mx-auto max-w-7xl px-5 lg:px-10"><p className="label-mono text-[10px] uppercase tracking-[.25em] text-primary">XR AGENCY · NOTRE HISTOIRE</p><h1 className="display-serif mt-5 max-w-5xl text-[clamp(3.5rem,9vw,8rem)] leading-[.84]">France.<br/><em className="not-italic italic text-primary">Asie.</em><br/>International.</h1><p className="mt-8 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">XR Agency accompagne les entreprises qui veulent transformer leur présence digitale en véritable outil commercial : stratégie, design, développement, visibilité et accompagnement continu.</p></div><figure className="mx-auto mt-10 max-w-7xl overflow-hidden rounded-[2rem] border border-border/70"><img src={XR_JOURNEY_PHOTO} alt="Architecture contemporaine et ville internationale" className="h-[360px] w-full object-cover object-center sm:h-[500px]" loading="eager" decoding="async"/><figcaption className="border-t border-border/60 bg-card/70 px-5 py-3 label-mono text-[9px] uppercase tracking-[.16em] text-muted-foreground">France · Asie · International</figcaption></figure></section>
