...
const SEO_COPY = {
  fr: {
    ...
    scrollHint: "Les 3 accompagnements sont présentés ci-dessous",
    ...
    plans: [
      { name: "SEO Local", price: "299 €", period: "/ mois", tagline: "Construire une présence locale solide.", audience: "Pour commerces, indépendants, restaurants, cabinets et entreprises locales.", features: ["Audit technique & sémantique initial", "Recherche de mots-clés locaux & intentions", "Optimisation des pages stratégiques", "Structure et maillage interne", "Plan éditorial local", "Suivi des performances", "Rapport mensuel & recommandations"] },
      { name: "SEO Boost", price: "499 €", period: "/ mois", tagline: "Accélérer la visibilité et le trafic qualifié.", audience: "Pour entreprises qui veulent produire, optimiser et renforcer leur couverture sémantique.", popular: true, features: ["Tout le SEO Local", "Stratégie sémantique approfondie", "Production & optimisation de contenus", "Optimisation technique continue", "Maillage interne avancé", "Analyse concurrentielle régulière", "Suivi des positions, trafic & conversions", "Rapport mensuel stratégique"] },
      { name: "SEO Pro", price: "799 €", period: "/ mois", tagline: "Déployer une véritable stratégie de domination organique.", audience: "Pour marques ambitieuses, marchés concurrentiels et entreprises nationales.", features: ["Tout le SEO Boost", "Stratégie SEO complète multi-intentions", "Production éditoriale renforcée", "Optimisations techniques prioritaires", "Stratégie d'autorité & netlinking", "Analyse concurrentielle avancée", "Pilotage des opportunités de croissance", "Reporting et recommandations de direction"] },
    ],
    pillars: [["01", "Technique", "Indexation, architecture, performances, données, maillage et fondations nécessaires à une croissance saine."], ["02", "Sémantique & contenu", "Nous construisons une couverture de recherche autour des intentions réellement utiles à votre activité."], ["03", "Autorité", "Popularité, pertinence, concurrence et signaux externes : nous renforçons progressivement votre positionnement."]],
  ...
  en: {
    ...
    scrollHint: "The 3 growth tracks are presented below",
  ...
  vi: {
    ...
    scrollHint: "3 cấp độ đồng hành được trình bày bên dưới",
