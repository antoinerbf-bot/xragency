  ...
  if (!crawl.https) {
    issues.push(
      issue({
        ...
        description:
          "The website is served over HTTP instead of HTTPS. Data transmitted between visitors and the site is not encrypted.",
        whyItMatters:
          "Modern browsers flag HTTP sites as 'Not Secure', and Google uses HTTPS as a ranking signal.",
        businessImpact:
          "Visitors see security warnings, reducing trust and increasing bounce rates. Search rankings may drop.",
  ...
  if (!crawl.robotsTxt) {
    issues.push(
      issue({
        ...
        businessImpact:
          "Without guidance, crawlers may index low-value pages or waste crawl budget.",
    ...
    if (!home.viewport) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Without a viewport tag, mobile browsers render the page at desktop width, making it unreadable.",
          businessImpact:
            "Mobile visitors (often 50%+ of traffic) will have a poor experience and leave.",
          recommendation:
    ...
    if (!home.canonical) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Canonical tags prevent duplicate content issues by telling search engines the preferred URL.",
          businessImpact:
            "Duplicate content can dilute search rankings across multiple URL variations.",
          recommendation:
            'Add a <link rel="canonical"> tag pointing to the preferred homepage URL.',
          scoreImpact: -1,
          pageUrl: home.url,
        }),
      );
    ...
    if (imagesWithoutAlt.length > 0) {
      issues.push(
        issue({
          ...
          businessImpact:
            "Visually impaired users cannot understand image content. Image search traffic is lost.",
          recommendation:
            "Add descriptive alt text to every image, including relevant keywords where appropriate.",
    ...
    if (!home.title) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "The title tag is the #1 on-page SEO factor. It appears in search results and browser tabs.",
          businessImpact:
            "Without a title, search engines struggle to understand the page topic. CTR drops dramatically.",
          recommendation:
            "Create a unique, keyword-rich title (50-60 characters) for the homepage.",
          scoreImpact: -8,
          pageUrl: home.url,
        }),
      );
    ...
    if (!home.metaDescription) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Search engines generate their own snippets when no meta description exists, often poorly.",
          businessImpact:
            "Lower click-through rates from search results. Potential customers skip your listing.",
          recommendation:
            "Write a compelling meta description (150-160 chars) with a clear value proposition and call to action.",
          scoreImpact: -4,
          pageUrl: home.url,
        }),
      );
    ...
    if (home.h1.length === 0) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "H1 is the primary heading signal for search engines to understand page content.",
          businessImpact:
            "Search engines may misinterpret the page topic, reducing relevant traffic.",
      ...
      issues.push(
        issue({
          ...
          whyItMatters:
            "Multiple H1s dilute the heading signal and confuse search engines about the main topic.",
    ...
    if (home.wordCount < 300) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Search engines favor comprehensive content that thoroughly covers a topic.",
          businessImpact:
            "Thin content ranks poorly, losing organic traffic to competitors with richer pages.",
          recommendation:
            "Expand content with detailed service descriptions, value propositions, and relevant keywords.",
          scoreImpact: -5,
          pageUrl: home.url,
        }),
      );
  ...
  if (home && (!home.ogTitle || !home.ogDescription)) {
    issues.push(
      issue({
        ...
        whyItMatters:
          "Open Graph tags control how links appear when shared on social media and messaging apps.",
    ...
    if (!home.hasCTA) {
      issues.push(
        issue({
          ...
          description:
            "No prominent CTA button, form, or action-oriented link was detected on the homepage.",
          whyItMatters:
            "Visitors need clear guidance on what to do next. Without a CTA, they leave without converting.",
          businessImpact:
            "Lost conversions. Visitors leave the site without contacting, buying, or booking.",
          recommendation:
            "Add a prominent, compelling CTA above the fold (e.g., 'Get a Free Quote', 'Book a Consultation').",
          scoreImpact: -6,
          pageUrl: home.url,
        }),
      );
    ...
    if (!home.hasContactForm && !home.hasPhone && !home.hasEmail) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Visitors who want to reach you have no way to do so. This is a conversion killer.",
          businessImpact: "Every visitor who wants to contact you but can't is lost revenue.",
          recommendation:
            "Add a contact form, phone number, and email address prominently on the homepage.",
          scoreImpact: -8,
          pageUrl: home.url,
        }),
      );
    ...
    if (!home.hasTestimonials) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Social proof is one of the strongest conversion drivers. Visitors trust other customers' experiences.",
          businessImpact:
            "Without social proof, visitors have no reason to trust your business over competitors.",
          recommendation:
            "Add customer testimonials, Google reviews, or case study snippets to the homepage.",
          scoreImpact: -3,
          pageUrl: home.url,
        }),
      );
...
function analyzeLocal(crawl: CrawlResult): AuditIssue[] {
  ...
  if (home) {
    ...
    if (!home.hasAddress && !home.hasPhone) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Local businesses need NAP (Name, Address, Phone) for Google Maps ranking and local trust.",
          businessImpact:
            "Google may not rank you in local searches. Nearby customers find competitors instead.",
          recommendation:
            "Add your full business address and phone number to the homepage and contact page.",
          scoreImpact: -5,
          pageUrl: home.url,
        }),
      );
    ...
    if (!home.hasAddress) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "A physical address is a strong local SEO signal and builds trust with local customers.",
          businessImpact:
            "Lower Google Maps ranking. Customers may perceive the business as less legitimate.",
    ...
    const hasGoogleMaps = crawl.pages.some(
      (p) =>
        p.socialLinks.some((l) => /maps\.google|google\.com\/maps/i.test(l)) ||
    ...
    if (!hasGoogleMaps) {
      issues.push(
        issue({
          ...
          recommendation:
            "Add a link to your Google Business Profile in the footer or contact section.",
          scoreImpact: -2,
          pageUrl: home.url,
        }),
      );
    ...
    if (home.loadTime && home.loadTime > 3000) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Google recommends pages load in under 2.5 seconds. Slow sites lose visitors and rankings.",
          businessImpact:
    ...
    if (home.images.length > 30) {
      issues.push(
        issue({
          ...
          whyItMatters:
            "Each image adds download time. Unoptimized images are the #1 cause of slow pages.",
          businessImpact: "Slow pages increase bounce rate and decrease conversions.",
          recommendation:
            "Compress images, use WebP format, implement lazy loading, and remove unnecessary images.",
          scoreImpact: -3,
          pageUrl: home.url,
        }),
      );
    ...
    if (home.externalLinks.length > 20) {
      issues.push(
        issue({
          ...
          recommendation:
            'Review external links and add rel="nofollow" where appropriate. Remove unnecessary ones.',
          scoreImpact: -1,
          pageUrl: home.url,
        }),
      );
