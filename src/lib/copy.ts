...
export const UI: Record<string, L> = {
  ...
  navPricing: { fr: "Tarifs", en: "Pricing", vi: "Bảng giá", ar: "الأسعار", ru: "Цены" },
  navWork: { fr: "Réalisations", en: "Work", vi: "Dự án", ar: "الأعمال", ru: "Проекты" },
  navIntelligence: { fr: "Intelligence", en: "Intelligence", vi: "Intelligence", ar: "الذكاء", ru: "Интеллект" },
  ...
  heroEdition: { fr: "Édition MMXXVI", en: "Edition MMXXVI", vi: "Ấn bản MMXXVI", ar: "إصدار MMXXVI", ru: "Издание MMXXVI" },
  heroReadTime: { fr: "Lecture 4 min", en: "4 min read", vi: "Đọc 4 phút", ar: "قراءة 4 دقائق", ru: "Чтение · 4 мин" },
  heroSummary: { fr: "Sommaire", en: "Summary", vi: "Mục lục", ar: "المحتويات", ru: "Содержание" },
  heroPlate: { fr: "Planche — I", en: "Plate — I", vi: "Bản — I", ar: "لوحة — I", ru: "Планшет — I" },
  heroQuote: {
  ...
  showcaseVisitSite: { fr: "Visiter le site", en: "Visit website", vi: "Xem website", ar: "زيارة الموقع", ru: "Открыть сайт" },
  showcaseAllSectors: { fr: "Tous les secteurs", en: "All sectors", vi: "Tất cả lĩnh vực", ar: "جميع القطاعات", ru: "Все отрасли" },
  showcaseAllServices: { fr: "Tous les services", en: "All services", vi: "Tất cả dịch vụ", ar: "جميع الخدمات", ru: "Все услуги" },
  serviceWebsite: { fr: "Site web", en: "Website", vi: "Website", ar: "موقع إلكتروني", ru: "Сайт" },
  serviceEcommerce: { fr: "E-commerce", en: "E-commerce", vi: "Thương mại điện tử", ar: "التجارة الإلكترونية", ru: "E-commerce" },
  serviceBooking: { fr: "Réservation", en: "Booking", vi: "Đặt chỗ" },
  serviceBranding: { fr: "Branding", en: "Branding", vi: "Thương hiệu", ar: "الهوية والعلامة", ru: "Брендинг" },
  serviceSeo: { fr: "SEO", en: "SEO", vi: "SEO", ar: "SEO", ru: "SEO" },
  serviceSocial: { fr: "Social Media", en: "Social Media", vi: "Mạng xã hội", ar: "وسائل التواصل", ru: "Соцсети" },
  serviceStrategy: { fr: "Stratégie digitale", en: "Digital Strategy", vi: "Chiến lược số" },
  serviceAi: { fr: "IA", en: "AI", vi: "AI", ar: "الذكاء الاصطناعي", ru: "ИИ" },
  serviceWebcare: { fr: "Webcare", en: "Webcare", vi: "Webcare", ar: "WebCare", ru: "WebCare" },
  ...
  legalHostingProvider: {
    fr: "o2switch — Chemin des Pardiaux, 63000 Clermont-Ferrand, France",
    en: "o2switch — Chemin des Pardiaux, 63000 Clermont-Ferrand, France",
    vi: "o2switch — Chemin des Pardiaux, 63000 Clermont-Ferrand, France",
    ar: "o2switch — Chemin des Pardiaux، 63000 Clermont-Ferrand، France",
    ru: "o2switch — Chemin des Pardiaux, 63000 Clermont-Ferrand, France",
  },
  legalCopyright: {
    fr: "© 2026 XR Agency — Tous droits réservés",
    en: "© 2026 XR Agency — All rights reserved",
