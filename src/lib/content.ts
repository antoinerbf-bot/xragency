...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    plans: [
      {
        name: { fr: "SEO Foundation", en: "SEO Foundation", vi: "SEO Foundation" },
        audience: { fr: "Fondations techniques, sémantiques et locales.", en: "Technical, semantic and local foundations.", vi: "Nền tảng kỹ thuật, ngữ nghĩa và địa phương." },
        eur: 299,
        period: "month",
        features: [
          { fr: "Audit SEO initial", en: "Initial SEO audit", vi: "Audit SEO ban đầu" },
          { fr: "Recherche et mapping des mots-clés", en: "Keyword research and mapping", vi: "Nghiên cứu và lập bản đồ từ khóa" },
          { fr: "Optimisation on-page", en: "On-page optimization", vi: "Tối ưu on-page" },
          { fr: "Structure, métadonnées et maillage interne", en: "Structure, metadata and internal linking", vi: "Cấu trúc, metadata và liên kết nội bộ" },
          { fr: "Suivi technique selon périmètre", en: "Technical monitoring within scope", vi: "Theo dõi kỹ thuật theo phạm vi" },
          { fr: "Reporting mensuel", en: "Monthly reporting", vi: "Báo cáo hàng tháng" },
        ],
      },
      {
        name: { fr: "SEO Growth", en: "SEO Growth", vi: "SEO Growth" },
        audience: { fr: "Accompagnement renforcé pour développer la visibilité organique.", en: "Enhanced support to develop organic visibility.", vi: "Hỗ trợ tăng cường để phát triển khả năng hiển thị tự nhiên." },
        eur: 499,
        period: "month",
        popular: true,
        features: [
          { fr: "Tout SEO Foundation", en: "Everything in SEO Foundation", vi: "Tất cả trong SEO Foundation" },
          { fr: "Stratégie éditoriale mensuelle", en: "Monthly editorial strategy", vi: "Chiến lược nội dung hàng tháng" },
          { fr: "Jusqu'à 4 contenus SEO / mois", en: "Up to 4 SEO content assets / month", vi: "Tối đa 4 nội dung SEO / tháng" },
          { fr: "SEO local et Google Business Profile", en: "Local SEO and Google Business Profile", vi: "SEO địa phương và Google Business Profile" },
          { fr: "Analyse concurrentielle et autorité", en: "Competitor and authority analysis", vi: "Phân tích cạnh tranh và authority" },
          { fr: "Reporting et point stratégique mensuels", en: "Monthly reporting and strategy review", vi: "Báo cáo và rà soát chiến lược hàng tháng" },
        ],
      },
      {
        name: { fr: "SEO Domination", en: "SEO Domination", vi: "SEO Domination" },
        audience: { fr: "Pour les marchés compétitifs et les stratégies multi-locales.", en: "For competitive markets and multi-location strategies.", vi: "Dành cho thị trường cạnh tranh và chiến lược đa địa điểm." },
        eur: 699,
        period: "month",
        features: [
          { fr: "Tout SEO Growth", en: "Everything in SEO Growth", vi: "Tất cả trong SEO Growth" },
          { fr: "Jusqu'à 8 contenus SEO / mois", en: "Up to 8 SEO content assets / month", vi: "Tối đa 8 nội dung SEO / tháng" },
          { fr: "SEO technique avancé", en: "Advanced technical SEO", vi: "SEO kỹ thuật nâng cao" },
          { fr: "SEO international ou multi-local", en: "International or multi-location SEO", vi: "SEO quốc tế hoặc đa địa điểm" },
          { fr: "Stratégie d'autorité et backlinks", en: "Authority and backlink strategy", vi: "Chiến lược authority và backlink" },
          { fr: "Suivi renforcé et reporting", en: "Enhanced monitoring and reporting", vi: "Theo dõi và báo cáo nâng cao" },
        ],
      },
    ],
  {
