    ...
    plans: [
      {
        ...
        features: [
          ...
          { fr: "Langue supplémentaire : +100 € / langue", en: "Extra language: +$108 / language", vi: "Thêm ngôn ngữ: +100 € / ngôn ngữ" },
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          { fr: "Catalogue produits sur-mesure", en: "Bespoke product catalogue", vi: "Danh mục sản phẩm riêng" },
          ...
          { fr: "Option : système de réservation (supplément)", en: "Option: booking system (add-on)", vi: "Tùy chọn: hệ thống đặt chỗ (phụ phí)" },
          { fr: "Option : multilingue +100 € / langue", en: "Option: multilingual +$108 / language", vi: "Tùy chọn: đa ngôn ngữ +100 € / ngôn ngữ" },
        ],
      },
    ],
  },
...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    field: { fr: "Gastronomie & Réservation", en: "Fine dining & Booking", vi: "Ẩm thực & Đặt bàn" },
    quote: {
  ...
  },
  {
    ...
    brand: "Neo Gear",
    field: { fr: "E-commerce & Conversion", en: "E-commerce & Conversion", vi: "Thương mại điện tử & Chuyển đổi" },
    quote: {
    ...
    author: "Karim Haddad",
    role: { fr: "Directeur e-commerce", en: "E-commerce Director", vi: "Giám đốc Thương mại điện tử" },
  },
];