...
const translations = {
  ...
  services: {
    ...
    items: [
      { num: '01', name: { fr: 'Création de Sites Web', en: 'Website Creation', vi: 'Tạo Website' }, price: 500, metric: { fr: '100/100 PageSpeed', en: '100/100 PageSpeed', vi: '100/100 PageSpeed' }, desc: { fr: 'Sites web responsive sur mesure pour performance et conversion.', en: 'Custom responsive websites built for performance and conversion.', vi: 'Website responsive tùy chỉnh cho hiệu suất và chuyển đổi.' } },
      { num: '02', name: { fr: 'Branding & Identité', en: 'Branding & Identity', vi: 'Thương Hiệu & Nhận Diện' }, price: 200, metric: { fr: 'Droits complets inclus', en: 'Full rights included', vi: 'Bao gồm toàn quyền' }, desc: { fr: 'Identité visuelle complète : logo, typographie, palette, charte.', en: 'Complete visual identity: logo, typography, color palette, brand guidelines.', vi: 'Nhận diện trực quan: logo, typography, bảng màu, quy chuẩn.' } },
      { num: '03', name: { fr: 'Système de Domination SEO', en: 'SEO Domination System', vi: 'Hệ Thống Thống Trị SEO' }, price: 200, period: '/mois', metric: { fr: '+340% trafic organique', en: '+340% organic traffic', vi: '+340% traffic hữu cơ' }, desc: { fr: 'Stratégie SEO complète pour dominer les résultats de recherche.', en: 'Comprehensive SEO strategy for dominating search results.', vi: 'Chiến lược SEO toàn diện để thống trị kết quả tìm kiếm.' } },
      { num: '04', name: { fr: 'Google Maps TOP 3', en: 'Google Maps TOP 3', vi: 'Google Maps TOP 3' }, price: 1000, period: '/an', metric: { fr: '90% clics Top 3', en: '90% clicks Top 3', vi: '90% click Top 3' }, desc: { fr: 'Optimisation SEO local pour ranker dans le Top 3 Google Maps.', en: 'Local SEO optimization to rank in the Google Maps Top 3.', vi: 'Tối ưu SEO local để xếp hạng Top 3 Google Maps.' } },
      { num: '05', name: { fr: 'Community Management', en: 'Community Management', vi: 'Quản Lý Cộng Đồng' }, price: 250, period: '/mois', metric: { fr: '+250% engagement', en: '+250% engagement', vi: '+250% tương tác' }, desc: { fr: 'Gestion des réseaux sociaux et création de contenu multi-plateformes.', en: 'Social media management and content creation across platforms.', vi: 'Quản lý mạng xã hội và tạo nội dung đa nền tảng.' } },
      { num: '06', name: { fr: 'Maintenance WebCare', en: 'WebCare Maintenance', vi: 'Bảo Trì WebCare' }, price: 29, period: '/mois', metric: { fr: '99,9% uptime', en: '99.9% uptime', vi: '99,9% uptime' }, desc: { fr: 'Maintenance continue, mises à jour sécurité et monitoring performance.', en: 'Ongoing maintenance, security updates, and performance monitoring.', vi: 'Bảo trì liên tục, cập nhật bảo mật và giám sát hiệu suất.' } },
      { num: '07', name: { fr: 'Assistants IA 24/7', en: 'AI Assistants 24/7', vi: 'Trợ Lý AI 24/7' }, price: 500, period: '/mois', metric: { fr: '-80% coûts support', en: '-80% support costs', vi: '-80% chi phí hỗ trợ' }, desc: { fr: 'Chatbots IA personnalisés pour support client et qualification de leads.', en: 'Custom AI chatbots for customer support and lead qualification.', vi: 'Chatbot AI tùy chỉnh cho hỗ trợ khách hàng và đánh giá lead.' } },
      { num: '08', name: { fr: 'E-commerce', en: 'E-commerce', vi: 'Thương Mại Điện Tử' }, price: 800, metric: { fr: 'Shopify & WooCommerce', en: 'Shopify & WooCommerce', vi: 'Shopify & WooCommerce' }, desc: { fr: 'Solutions e-commerce complètes avec intégration paiement.', en: 'Full e-commerce solutions with payment integration.', vi: 'Giải pháp thương mại điện tử tích hợp thanh toán.' } },
      { num: '09', name: { fr: 'Refonte de Site Web', en: 'Website Redesign', vi: 'Thiết Kế Lại Website' }, price: 500, metric: { fr: 'Audit UX complet', en: 'Full UX audit', vi: 'Kiểm toán UX toàn diện' }, desc: { fr: 'Refonte complète avec audit UX et redesign moderne.', en: 'Complete website overhaul with UX audit and modern redesign.', vi: 'Làm mới website với kiểm toán UX và thiết kế hiện đại.' } },
      { num: '10', name: { fr: 'Publicité Digitale', en: 'Digital Advertising', vi: 'Quảng Cáo Kỹ Thuật Số' }, price: 500, period: '/mois', metric: { fr: 'ROAS > 4x', en: 'ROAS > 4x', vi: 'ROAS > 4x' }, desc: { fr: 'Campagnes publicitaires sur Google, Meta et LinkedIn.', en: 'Paid advertising campaigns across Google, Meta, and LinkedIn.', vi: 'Chiến dịch quảng cáo trên Google, Meta và LinkedIn.' } },
      { num: '11', name: { fr: 'Stratégie Digitale', en: 'Digital Strategy', vi: 'Chiến Lược Kỹ Thuật Số' }, price: 800, metric: { fr: 'Analyse de marché', en: 'Market analysis', vi: 'Phân tích thị trường' }, desc: { fr: 'Stratégie digitale complète avec analyse concurrentielle.', en: 'Comprehensive digital strategy with competitive analysis.', vi: 'Chiến lược số toàn diện với phân tích cạnh tranh.' } },
    ],
  },
  ...
  pricing: {
    ...
    plans: {
      showcase: {
        ...
        features: {
          fr: ['Design responsive premium', 'Jusqu\'à 3 pages', 'Formulaire de contact', 'Optimisation SEO de base', 'Hébergement 1 an inclus', 'Livraison en 7 jours', 'Langue supplémentaire : +100 € / langue'],
          en: ['Premium responsive design', 'Up to 3 pages', 'Contact form', 'Basic SEO optimization', '1 year hosting included', '7-day delivery', 'Additional language: +€100 / language'],
          vi: ['Thiết kế responsive cao cấp', 'Tối đa 3 trang', 'Form liên hệ', 'Tối ưu SEO cơ bản', 'Hosting 1 năm bao gồm', 'Giao hàng 7 ngày', 'Ngôn ngữ bổ sung: +€100 / ngôn ngữ'],
        },
      },
      business: {
  ...
  inspirations: {
    ...
    disclaimer: { fr: "Les sites présentés sont des références de direction artistique, pas des projets clients XR Agency.", en: 'The sites shown are art direction references, not XR Agency client projects.', vi: 'Các website hiển thị là tham khảo định hướng nghệ thuật, không phải dự án khách hàng XR Agency.' },
  },
