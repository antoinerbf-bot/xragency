...
export function MapsSimulator() {
  ...
  return (
    <div className="space-y-24">
      ...
      <div className="surface-plate relative overflow-hidden rounded-3xl border border-border bg-card p-6 sm:p-10 shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="display-serif text-2xl text-foreground">
                Simulateur de Visibilité Google Maps
              </h3>
              <p className="label-mono text-xs text-muted-foreground">
                Évaluez le potentiel d'acquisition locale de votre établissement
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-primary/30 bg-accent/25 p-6 sm:p-8 lg:col-span-5">
            <div>
              ...
              <div className="mt-6 rounded-2xl border border-primary/40 bg-card p-5">
                ...
                <p className="mt-3 text-[11px] leading-relaxed text-muted-foreground">
                  * Tarif indicatif de départ (à partir de 990 €). Le montant final est confirmé
                  après audit de concurrence et validation de vos zones cibles.
                </p>

                <div className="mt-4 flex items-center gap-2 border-t border-border/60 pt-3 text-xs text-emerald-400">
                  <ShieldCheck className="h-4 w-4 shrink-0" />
                  <span className="font-medium">
                    Objectif TOP 3 garanti sur 1 an · Satisfait ou remboursé
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex w-full items-center justify-center gap-2 rounded-full bg-primary py-3.5 text-xs font-semibold uppercase tracking-wider text-primary-foreground shadow-lg transition-all hover:bg-primary/90"
              >
                <MessageCircle className="h-4 w-4" />
                Lancer mon audit Google Maps
              </a>
            </div>
          </div>
        </div>
