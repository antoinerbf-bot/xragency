...
export function Hero(){
 ...
 return <section id="top" className="grain relative flex min-h-[100svh] items-end overflow-hidden bg-zinc-950 text-white">
   <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_25%,rgba(214,154,78,.32),transparent_28%),linear-gradient(125deg,#090909,#211b14_52%,#070707)]"><div className="absolute inset-0 animate-pulse-soft bg-[radial-gradient(ellipse_at_55%_45%,rgba(255,194,105,.16),transparent_40%)]"/><div className="absolute -inset-[15%] animate-slow-spin bg-[conic-gradient(from_90deg,transparent,rgba(255,183,82,.09),transparent_35%)]"/></div><div className="absolute inset-0">
    {canPlay?<video ref={videoRef} onError={e=>{e.currentTarget.style.display="none"}} autoPlay loop muted playsInline preload="metadata" poster="/media/hero-poster.webp" className="h-full w-full object-cover object-center" aria-hidden><source src="/__l5e/assets-v1/22bc4b57-f585-4301-9b43-db26f682e9a7/hero-studio.mp4" media="(min-width:768px)" type="video/mp4"/><source src="/media/hero-desktop.mp4" media="(min-width:768px)" type="video/mp4"/><source src="/media/hero-mobile.mp4" type="video/mp4"/></video>:<img src="/media/hero-poster.webp" alt="" className="h-full w-full object-cover object-center"/>}
